        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-muted-foreground">
            {!canReadTasks 
              ...
              : "Skúste obnoviť stránku alebo sa vráťte späť"}
          </p>
        </div>
      </div>
    );
            ...
            <div className="flex gap-2 items-center h-7">
              ...
              <Popover open={canUpdateTasks ? projectSelectOpen : false} onOpenChange={canUpdateTasks ? setProjectSelectOpen : undefined}>
                <PopoverTrigger asChild>
                  ...
                  >
                    <Folder className="h-3 w-3 text-[#90a1b9] dark:text-muted-foreground shrink-0" />
                    <span className="text-sm font-medium text-[#90a1b9] dark:text-muted-foreground tracking-[-0.15px]">
                      Bez projektu
                    </span>
                  </button>
                </PopoverTrigger>
