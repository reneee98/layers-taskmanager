...
-- This will allow us to test the auth system without RLS issues
...
-- Disable RLS on other tables temporarily for testing
...
-- Insert a test profile manually for testing
-- This will be created when you create a user in Supabase Auth
