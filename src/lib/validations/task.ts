...
export const taskSchema = z.object({
  ...
  sales_commission_enabled: z.boolean().optional().nullable(),
  sales_commission_user_id: z.union([
    z.string().uuid("Neplatné ID používateľa"),
    z.null(),
    z.undefined(),
    z.literal("")
  ]).transform((val) => val === "" || val === undefined ? null : val).optional().nullable(),
  sales_commission_percent: z.union([
    z.number().min(0, "Percento musí byť kladné").max(100, "Percento nemôže byť viac ako 100"),
    z.null(),
    z.undefined()
  ]).optional().nullable(),
});
